...
class ProductPriceSummary(BaseModel):
    """Batch price/title/image lookup response item — new upstream dependency for
    US-004 (Cart Service) totals enrichment, see docs/design/services/cart-service/design.md."""
