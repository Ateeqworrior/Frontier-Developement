...
_STATUS_BY_EXC = {
    ...
    OnboardingVersionConflictError: status.HTTP_409_CONFLICT,
    OnboardingValidationError: status.HTTP_422_UNPROCESSABLE_ENTITY,
    OnboardingIncompleteError: status.HTTP_422_UNPROCESSABLE_ENTITY,
    InvalidDocumentFieldError: status.HTTP_422_UNPROCESSABLE_ENTITY,
    RemarksRequiredError: status.HTTP_422_UNPROCESSABLE_ENTITY,
    CommentsRequiredError: status.HTTP_422_UNPROCESSABLE_ENTITY,
    OnboardingLockedError: status.HTTP_409_CONFLICT,
    VendorOnboardingNotFoundError: status.HTTP_404_NOT_FOUND,
    CartItemNotFoundError: status.HTTP_404_NOT_FOUND,
    WishlistItemNotFoundError: status.HTTP_404_NOT_FOUND,
    InvalidPinCodeError: status.HTTP_422_UNPROCESSABLE_ENTITY,
}
