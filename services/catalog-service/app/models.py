...
from sqlalchemy import DECIMAL, ForeignKey, Index, Integer, String, Text, UniqueConstraint
...
class Wishlist(Base):
    """`wishlists` (HLD/LLD §4.3.5): user_id + product_id, owned by Catalog Service.
    Per ADR-0004, US-004 (Cart Service) calls this table only through this service's
    `/api/v1/wishlist/*` API — never directly."""
