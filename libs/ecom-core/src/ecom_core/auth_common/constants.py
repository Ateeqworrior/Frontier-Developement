...
ROLE_PERMISSIONS: dict[str, set[str]] = {
    ...
    "admin": {
        ...
        "category:*", "attribute:*", "platform:*", "vendor_onboarding:review",
    },
    "vendor": {
        ...
        "vendor_onboarding:write", "vendor_onboarding:read",
    },
    "sponsor": {
        "product:read", "order:create", "cart:*", "wishlist:*", "payment:*",
        "sponsorship:read", "sponsorship:create",
    },
    "user": {
        "product:read", "order:read", "order:create", "cart:*", "wishlist:*",
